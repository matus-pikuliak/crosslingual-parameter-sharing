...
fine-tuning 89.69 80.24 85.25 86.77 79.11 82.64 84.67 86.87 99.08 94.83 96.05 96.73 
error-reduction 4.89 1.54 2.19 2.67 15.89 9.17 0.73 6.95 18.92 11.02 4.24 14.12 
sota 91.68 80.36 84.57 90.93 - - - ? 99.07 94.50 95.94 98.80
'''

for line in st.strip().split('\n'):
    print(f'{" & ".join(line.strip().split())} \\\\ \hline')
exit()
