...
def additional_stats(name, datum):
    ...
    if os.path.isfile(h5_filepath):
        with h5py.File(h5_filepath, 'r') as h5:
            ...
            output['cont_repr_weights_input_norm'] = list(output['cont_repr_weights_input_norm'])
            ...
            output['cont_repr_weights_output_norm'] = list(output['cont_repr_weights_output_norm'])
            ...
            output['cont_repr_weights_grad_input_norm'] = list(output['cont_repr_weights_grad_input_norm'])
            ...
            output['cont_repr_weights_grad_output_norm'] = list(output['cont_repr_weights_grad_output_norm'])
